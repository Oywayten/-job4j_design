...
declare prod_curs scroll cursor for
    select * from products;


fetch last from prod_curs;

fetch backward 5 from prod_curs;

fetch backward from prod_curs;

move backward 8 from prod_curs;

fetch backward 5 from prod_curs;

fetch prior from prod_curs;
